...
You still can use the [shell]{.text-background-primary_blue}.
 ...
 * [A script]{.text-background-dark_blue} is a record of code.
 * [Project]{.text-background-dark_blue} is self contained project/study/paper containg scripts, data, figures, etc.
